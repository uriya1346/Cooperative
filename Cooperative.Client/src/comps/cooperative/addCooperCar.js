    ...
    <div className="container mb-5">
      ...
      <div style={{ minHeight: "15vh" }}></div>
      {
        <form
          ...
          className="col-md-7 p-3 shadow mx-auto form-design text-dark"
        >
          ...
          <label className="my-2">
            <i
              className="fa fa-american-sign-language-interpreting mx-2"
              aria-hidden="true"
            ></i>
            Car Name
          </label>
          ...
          {errors.name ? (
            <small className="text-danger d-block">
              * Enter valid name 2 to 150 chars
            </small>
          ) : (
            ""
          )}
          ...
          <label className="my-2">
            <i className="fa fa-location-arrow mx-2" aria-hidden="true"></i>Full
          ...
          {errors.address ? (
            <small className="text-danger d-block">
              * Enter valid address 2 to 150 chars
            </small>
          ) : (
            ""
          )}
          ...
          <textarea
            ...
            className="form-control"
            rows="3"
            placeholder="type informatiom about the car..."
          ></textarea>
          {errors.info ? (
            <small className="text-danger d-block">
          ...
          <label className="my-2">
            <i className="fa fa-money mx-2" aria-hidden="true"></i>Price for 1
            hour
          </label>
          <input
            {...priceRef}
          ...
          {errors.price ? (
            <small className="text-danger d-block">
              * Enter valid price, between 1 to 999999
            </small>
          ) : (
            ""
          )}
          ...
          {errors.year ? (
            <small className="text-danger d-block">* Enter valid year</small>
          ) : (
            ""
          )}
          ...
          <input
            ...
            placeholder="type url of image car..."
          />
          {errors.img_url ? (
            <small className="text-danger d-block">
              * Enter valid img url{" "}
          ...
          <div className="text-center mt-4">
            <button className="btn btn-outline-success me-2" disabled={btnSend}>
              Add<i className="fa fa-plus mx-2" aria-hidden="true"></i>
            </button>
            <Link className="btn btn-outline-danger" to="/cooperative">
              Cancel
            </Link>
          </div>
        </form>
